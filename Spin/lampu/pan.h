...
#define SpinVersion	"Spin Version 6.5.2 -- 21 June 2024"
#define PanSource	"hm.pml"
...
#define _nstates21	14	/* f6 */
#define minseq21	347
#define maxseq21	359
#define _endstate21	13

#define _nstates20	14	/* f5 */
#define minseq20	334
#define maxseq20	346
#define _endstate20	13

#define _nstates19	14	/* f4 */
#define minseq19	321
#define maxseq19	333
#define _endstate19	13

#define _nstates18	14	/* f3 */
#define minseq18	308
#define maxseq18	320
#define _endstate18	13

#define _nstates17	14	/* f2 */
#define minseq17	295
#define maxseq17	307
#define _endstate17	13

#define _nstates16	14	/* f1 */
#define minseq16	282
#define maxseq16	294
#define _endstate16	13

#define _nstates15	14	/* l6 */
#define minseq15	269
#define maxseq15	281
#define _endstate15	13

#define _nstates14	14	/* l5 */
#define minseq14	256
#define maxseq14	268
#define _endstate14	13

#define _nstates13	14	/* l4 */
#define minseq13	243
#define maxseq13	255
#define _endstate13	13

#define _nstates12	14	/* l3 */
#define minseq12	230
#define maxseq12	242
#define _endstate12	13

#define _nstates11	14	/* l2 */
#define minseq11	217
#define maxseq11	229
#define _endstate11	13

#define _nstates10	14	/* l1 */
#define minseq10	204
#define maxseq10	216
#define _endstate10	13

#define _nstates9	11	/* sPED */
#define minseq9	194
#define maxseq9	203
#define _endstate9	10

#define _nstates8	11	/* sSW */
#define minseq8	184
#define maxseq8	193
#define _endstate8	10

#define _nstates7	11	/* sSN */
#define minseq7	174
#define maxseq7	183
#define _endstate7	10

#define _nstates6	11	/* sES */
#define minseq6	164
#define maxseq6	173
#define _endstate6	10

#define _nstates5	11	/* sNE */
#define minseq5	154
#define maxseq5	163
#define _endstate5	10

#define _nstates4	11	/* sWE */
#define minseq4	144
#define maxseq4	153
#define _endstate4	10

#define _nstates3	10	/* :init: */
#define minseq3	135
#define maxseq3	143
#define _endstate3	9

#define _nstates2	6	/* PedTrafficGenerator */
#define minseq2	130
#define maxseq2	134
#define _endstate2	5

#define _nstates1	10	/* CarTrafficGenerator */
#define minseq1	121
#define maxseq1	129
#define _endstate1	9

#define _nstates0	122	/* TrafficLight */
#define minseq0	0
#define maxseq0	120
#define _endstate0	121
...
#define PPedTrafficGenerator	((P2 *)_this)
typedef struct P2 { /* PedTrafficGenerator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define PCarTrafficGenerator	((P1 *)_this)
typedef struct P1 { /* CarTrafficGenerator */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define PTrafficLight	((P0 *)_this)
typedef struct P0 { /* TrafficLight */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, nValue) - 1*sizeof(short))
...
#else
	#define ACCEPT_LAB	18 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
