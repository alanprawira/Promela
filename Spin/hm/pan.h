...
#define PanSource	"lampujalan.pml"
...
#define _nstates7	14	/* :init: */
#define minseq7	75
#define maxseq7	87
#define _endstate7	13

#define _nstates6	46	/* TrafficLightController */
#define minseq6	30
#define maxseq6	74
#define _endstate6	45

#define _nstates5	6	/* Env_Ped */
#define minseq5	25
#define maxseq5	29
#define _endstate5	5

#define _nstates4	6	/* Env_SW */
#define minseq4	20
#define maxseq4	24
#define _endstate4	5

#define _nstates3	6	/* Env_SN */
#define minseq3	15
#define maxseq3	19
#define _endstate3	5

#define _nstates2	6	/* Env_ES */
#define minseq2	10
#define maxseq2	14
#define _endstate2	5

#define _nstates1	6	/* Env_NE */
#define minseq1	5
#define maxseq1	9
#define _endstate1	5

#define _nstates0	6	/* Env_WE */
#define minseq0	0
#define maxseq0	4
#define _endstate0	5
...
#define PTrafficLightController	((P6 *)_this)
typedef struct P6 { /* TrafficLightController */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	unsigned temp_req : 1;
	unsigned _13_1_has_conflict : 1;
	uchar my_id;
	uchar next_id;
	uchar my_chan;
} P6;
#define Air6	(sizeof(P6) - Offsetof(P6, my_chan) - 1*sizeof(uchar))

#define PEnv_Ped	((P5 *)_this)
typedef struct P5 { /* Env_Ped */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PEnv_SW	((P4 *)_this)
typedef struct P4 { /* Env_SW */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PEnv_SN	((P3 *)_this)
typedef struct P3 { /* Env_SN */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PEnv_ES	((P2 *)_this)
typedef struct P2 { /* Env_ES */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PEnv_NE	((P1 *)_this)
typedef struct P1 { /* Env_NE */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define PEnv_WE	((P0 *)_this)
typedef struct P0 { /* Env_WE */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	uchar statuses[6];
